...
import { getAllOrdersByUserId, getOrderDetais, resetOrderDetails } from "@/store/shop/order-slice";
...
function ShoppingOrders() {
    ...
    console.log("call--orderDetails", orderDetails);
