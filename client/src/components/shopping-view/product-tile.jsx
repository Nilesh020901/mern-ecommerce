        ...
        <Card className="w-full max-w-sm mx-auto">
            <div>
                ...
                <CardContent className="p-4">
                    ...
                    <div className="flex justify-between items-center mb-2">
                        <span className={`${product?.salePrice > 0 ? "line-through" : ""} text-lg text-primary font-medium`}>${product?.price}</span>
                        {
                            product?.salePrice > 0 ? <span className="text-lg text-primary font-medium">${product?.salePrice}</span> : null
                        }
                    </div>
                </CardContent>
                <CardFooter>
